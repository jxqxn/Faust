...
const ORIGINAL_FIELDS := {
	...
	"difficulty": {"type": "int", "clone": "difficulty_index", "status": "semantic", "note": "基数待验证（样本=1）"},
	"round": {"type": "int", "clone": "round_number", "status": "semantic", "note": "原作 round 即日计数；克隆另有 day 字段（原作无）"},
	"min_round": {"type": "int", "clone": "round_snapshots(内部)", "status": "semantic", "note": "回退下界；原作显式持久化"},
	...
	"only_cards": {"type": "HashSet<int>", "clone": "", "status": "missing", "note": "唯一卡登记"},
	"only_rites": {"type": "HashSet<int>", "clone": "", "status": "missing", "note": "唯一仪式登记"},
	...
	"gen_cards": {"type": "Dictionary<int,int>", "clone": "", "status": "missing", "note": "卡生成计数（166 键样本）"},
	"gen_tags": {"type": "Dictionary<string,int>", "clone": "", "status": "missing", "note": "标签生成计数"},
	"timing_rounds": {"type": "Dictionary<int,int>", "clone": "timing_rounds", "status": "mapped", "note": "player+0x128 周期事件重臂"},
	...
	"player_card_name": {"type": "Dictionary<int,string>", "clone": "", "status": "missing", "note": "卡名持久化"},
