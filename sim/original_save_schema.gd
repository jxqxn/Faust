...
const ORIGINAL_FIELDS := {
	...
	"sudan_box_show": {"type": "bool", "clone": "sudan_box_show", "status": "semantic", "note": "苏丹卡盒可见标志；2026-08-19 起克隆桌面盒已接，剧情/帮助 HUD 仍缺"},
	"story_unshow": {"type": "bool", "clone": "story_unshow", "status": "semantic", "note": "剧情 HUD 隐藏标志；原作桌面 HUD 未接"},
	"prestige_unshow": {"type": "bool", "clone": "prestige_unshow", "status": "semantic", "note": "声望 HUD 隐藏标志；2026-08-19 起克隆条已接，原作图标/交互仍缺"},
	"deadline_unshow": {"type": "bool", "clone": "deadline_unshow", "status": "semantic", "note": "死线 HUD 隐藏标志；2026-08-19 起克隆条已接，原作装饰/交互仍缺"},
	"helpbtn_unshow": {"type": "bool", "clone": "helpbtn_unshow", "status": "semantic", "note": "帮助按钮隐藏标志；原作桌面 HUD 未接"},
	...
	"sudan_card_init_life": {"type": "int", "clone": "sudan_card_init_life", "status": "mapped", "note": "新抽苏丹卡的 Player 头起步寿命"},
	"sudan_redraw_count": {"type": "int", "clone": "sudan_redraw_count", "status": "mapped", "note": ""},
	"sudan_redraw_times_per_round": {"type": "int", "clone": "sudan_redraw_times_per_round", "status": "mapped", "note": "SetDifficulty 更新"},
	"sudan_redraw_times": {"type": "int", "clone": "sudan_redraw_times", "status": "mapped", "note": "本恢复周期内已用普通重抽次数"},
	"sudan_redraw_times_recovery_round": {"type": "int", "clone": "sudan_redraw_times_recovery_round", "status": "mapped", "note": "Init 配置的恢复周期"},
	"wizard_first_show": {"type": "bool", "clone": "begin_guide(部分)", "status": "semantic", "note": "原作仅存此布尔；克隆持久化全量引导队列"},
	"success": {"type": "bool", "clone": "success", "status": "mapped", "note": "SetGameOver 的终局成功标志"},
	"over_reason": {"type": "int", "clone": "over_reason", "status": "mapped", "note": "结局原因（int.MinValue=未终局）"},
	...
	"sudan_pool_cards": {"type": "List<int>", "clone": "配置池证据", "status": "semantic", "note": "构造牌池用的配置 id 表；不会随抽牌缩短"},
	"sudan_pool": {"type": "string", "clone": "", "status": "missing", "note": "池变体字符串"},
	"sudan_card_pool": {"type": "List<Card>", "clone": "sudan_deck + sudan_pool_tags", "status": "semantic", "note": "实际剩余苏丹牌池；GenSudanCard 从此列表抽牌"},
	...
	"once_new_rites_is_show": {"type": "Dictionary<int,bool>", "clone": "once_new_rites_is_show", "status": "semantic", "note": "新仪式首见提示；仪式面板提示 UI 未接"},
