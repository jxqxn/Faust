...
const ORIGINAL_FIELDS := {
	...
	"sudan_box_show": {"type": "bool", "clone": "sudan_box_show", "status": "semantic", "note": "苏丹卡盒可见标志；原作桌面 HUD 未接"},
	"story_unshow": {"type": "bool", "clone": "story_unshow", "status": "semantic", "note": "剧情 HUD 隐藏标志；原作桌面 HUD 未接"},
	"prestige_unshow": {"type": "bool", "clone": "prestige_unshow", "status": "semantic", "note": "声望 HUD 隐藏标志；原作桌面 HUD 未接"},
	"deadline_unshow": {"type": "bool", "clone": "deadline_unshow", "status": "semantic", "note": "死线 HUD 隐藏标志；原作桌面 HUD 未接"},
