...
sample_l r7.xyzw, r7.xyzx, t8.xyzw, s0, r3.w
...
if_nz r4.w
  ...
  sample_l r5.xyzw, r5.xyzx, t9.xyzw, s0, r3.w
...
mad r5.xyz, -v2.xyzx, r2.wwww, cb1[0].xyzx
...
mad r5.x, |r2.w|, r3.w, r3.y
mad r3.w, r3.x, r3.w, r3.y
mul r2.w, |r2.w|, r3.w
mad r2.w, r3.x, r5.x, r2.w
